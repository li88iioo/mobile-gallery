        ...
        function showFullImage(index) {
            ...
            fullImageModal.innerHTML = `
                <div class="modal-content bg-black bg-opacity-90 p-0 relative flex items-center justify-center">
                    ...
                    <img src="${allImages[index]}" class="max-h-[90vh] w-auto object-contain" style="max-width: 90vw;">
        ...
        async function loadSiteSettings() {
            try {
                ...
                if (settings.title) {
                    ...
                    document.querySelector('h1 span').textContent = settings.title;
                }
        ...
        function loadLogoAndBackground() {
            ...
            // 设置标题
            const title = settings.title || '二手机展示';
